...
the parameters of the model and (Zt) a white noise.
...
We have 
$$
X_t= 0.136X_{t-1} + 1.2492X_{t-2} - 0.6388X_{t-3} - 0.5835X_{t-4} + 0.4538X_{t-5} + Z_{t} - 0.4778Z_{t-1} - 1.5956Z_{t-2} + 0.9202Z_{t-3} + 0.8193Z_{t-4} - 0.6402Z_{t-5}
$$
...
$$
\sigma_t^2 = 4.953 +0.9539 \sigma_{t-1}^2 + 0.0521 Z_{t-1}^2
$$
