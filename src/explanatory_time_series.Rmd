...
ts_PT08.S5.O3. = ts(daily_data$PT08.S5.O3., start=1, frequency = 1)
ts_stat_PT08.S5.O3. = diff(ts_PT08.S5.O3.)
FIRST = ts_stat_PT08.S5.O3.[(length(ts_stat_PT08.S5.O3.)-10 ):length(ts_stat_PT08.S5.O3.)]
...
model <- SSModel(Y[,-1] ~-1+ SSMregression(~ FIRST, Q=diag(NA,4),R=t(matrix(rep(diag(1,4),5),nrow=4))), H)
